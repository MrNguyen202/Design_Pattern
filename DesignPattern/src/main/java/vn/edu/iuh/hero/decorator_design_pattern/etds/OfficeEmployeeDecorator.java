/*
 * @ (#) OfficeEmployeeDecorator.java    1.0    3/4/2025
 *
 *
 */
...
public class OfficeEmployeeDecorator extends PositionDecorator {
    public OfficeEmployeeDecorator(EmployeeDecorator employeeDecorator) {
